...
export default function Under2Page() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-pink-200 via-purple-200 to-pink-200 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-5xl font-bold mb-4 text-purple-800">👶 Under 2 Years</h1>
          <p className="text-xl text-purple-700">Welcome to the baby zone!</p>
        </div>
        ...
        <div className="bg-white/90 rounded-lg p-8 backdrop-blur-sm shadow-2xl mb-8">
          <div className="text-center space-y-6">
            ...
            <h2 className="text-3xl font-bold text-purple-800">Early Learning & Development</h2>
              ...
              <div className="text-center">
                ...
                {selectedActivity === activity.id && (
                  <div className="mt-4 p-4 bg-purple-100 rounded-lg">
                    <p className="text-purple-800 text-sm">{activity.content}</p>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="bg-white/90 rounded-lg p-8 backdrop-blur-sm shadow-2xl">
          <div className="text-center">
            <h3 className="text-2xl font-bold text-purple-800 mb-4">🎵 Sound Play</h3>
            <button
              onClick={() => setSoundPlaying(!soundPlaying)}
              className="px-8 py-4 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-xl font-bold text-lg hover:from-pink-600 hover:to-purple-600 transition-all transform hover:scale-105"
            >
              {soundPlaying ? "⏸️ Pause Sounds" : "▶️ Play Gentle Sounds"}
            </button>
            {soundPlaying && (
              <p className="mt-4 text-purple-700">🎶 Playing gentle lullabies and soothing sounds...</p>
            )}
          </div>
        </div>
      </div>
