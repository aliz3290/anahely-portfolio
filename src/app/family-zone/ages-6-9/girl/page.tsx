...
export default function Ages6To9GirlPage() {
    ...
    <main className="min-h-screen bg-gradient-to-b from-purple-200 via-pink-200 to-purple-200 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-5xl font-bold mb-4 text-purple-800">🚀 Ages 6-9</h1>
          <p className="text-xl text-purple-700">Welcome to the elementary zone!</p>
        </div>
        ...
        <div className="bg-white/90 rounded-lg p-8 backdrop-blur-sm shadow-2xl mb-8">
          <div className="text-center space-y-6">
            ...
            <h2 className="text-3xl font-bold text-purple-800">Elementary Learning</h2>
        ...
        {selectedActivity === "math" && (
          <div className="bg-white/90 rounded-lg p-8 backdrop-blur-sm shadow-2xl mb-8">
            <h3 className="text-2xl font-bold text-purple-800 mb-4 text-center">🧮 Math Practice</h3>
            <div className="text-center space-y-4">
              ...
              <div className="flex gap-4 justify-center items-center">
                <input
                  ...
                  className="px-4 py-2 border-2 border-purple-300 rounded-lg text-xl text-center w-24"
                  placeholder="?"
                />
                <button
              ...
              {mathResult && (
                <div className="text-xl font-bold text-purple-800">{mathResult}</div>
              )}
            </div>
          </div>
        )}
        ...
        {selectedActivity === "reading" && (
          <div className="bg-white/90 rounded-lg p-8 backdrop-blur-sm shadow-2xl mb-8">
            <h3 className="text-2xl font-bold text-purple-800 mb-4 text-center">📖 Story Time</h3>
            <div className="space-y-4">
              <p className="text-lg text-purple-800 text-center">{stories[readingStory]}</p>
        ...
        {selectedActivity === "science" && (
          <div className="bg-white/90 rounded-lg p-8 backdrop-blur-sm shadow-2xl mb-8">
            <h3 className="text-2xl font-bold text-purple-800 mb-4 text-center">🔬 Science Experiments</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              {experiments.map((exp, index) => (
                ...
                >
                  <h4 className="font-bold text-purple-800">{exp.name}</h4>
                </button>
              ))}
            </div>
            {scienceExperiment && (
              <div className="bg-purple-100 rounded-lg p-6">
                <h4 className="font-bold text-purple-800 mb-3 text-xl">{scienceExperiment}</h4>
