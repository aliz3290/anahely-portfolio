...
export default function Ages10To13Page() {
...
rect(50, 50, 100, 100);`,
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-indigo-200 via-purple-200 to-indigo-200 py-8 px-4">
          ...
          <div className="bg-white/90 rounded-lg p-8 backdrop-blur-sm shadow-2xl mb-8">
            ...
            <div className="space-y-4">
              <div className="bg-gray-900 rounded-lg p-6 text-left">
                <div className="text-indigo-400 text-sm mb-2">{codeSnippets[codeSnippet].language}</div>
